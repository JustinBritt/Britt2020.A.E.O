namespace Britt2020.A.E.O.Factories.ResultElements.DayScenarioRecoveryWardCensuses
{
    using System;

    using log4net;

    using Britt2020.A.E.O.Classes.ResultElements.DayScenarioRecoveryWardCensuses;
